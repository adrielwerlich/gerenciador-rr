        ...
        <div class="card-header p-2">
          ...
          <div class="tab-pane active show" id="settings">
            <form class="form-horizontal">
              ...
              <div class="form-group">
                <label for="inputServiceAddress" class="col-sm-12 control-label">Endereço Que o Serviço será Feito</label>

                <div class="col-sm-10">

                <select id="user-address-list" class="form-control" 
              ...
              <div class="form-group col-sm-10" style="border:1px solid gold">
                    <label for="custom-dropzone" class="col-md-12 control-label">Choose a profile picture:</label>
