          ...
          <div class="tab-pane active show" id="settings">
            <form class="form-horizontal">
              <div class="form-group">
                <label for="inputName" class="col-md-12 control-label">Lista dos Tipos de Serviços Cadastrados</label>

                <div class="col-sm-10">

                    <select id="service-types-options" name="service-types-list" style="width:100%">
                        <option 
