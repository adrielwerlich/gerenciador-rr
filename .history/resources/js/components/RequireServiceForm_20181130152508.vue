          ...
          <div class="tab-pane active show" id="settings">
            <form class="form-horizontal">
              <div class="form-group">
                <label for="inputName" class="col-sm-2 control-label">Tipo de Serviço</label>

                <div class="col-sm-10">

                    <select id="service_types_options" name="cars">
...
export default {
  ...
  methods: {
      fetchServicesList(){
        axios.get('api/tipos-de-servico').then(lista_de_servicos => {
            this.services_list = lista_de_servicos.data.data
            console.log('this.services_list',this.services_list)
            console.log('lista_de_servicos',lista_de_servicos)
        })
      }
  }
};
